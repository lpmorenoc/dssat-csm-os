...
c1960 FORMAT (A6,1X,A16,1X,A6,1X,F6.2,F8.4,F7.2,F8.2,F7.3,F4.0)
 ...
 2040 FORMAT ('MODEL          ',A8,5X,A300)
 2050 FORMAT ('FILEX          ',A12,1X,A300)
 2100 FORMAT ('FILEA          ',A12,1X,A300)
 2200 FORMAT ('FILET          ',A12,1X,A300)
 2300 FORMAT ('SPECIES        ',A12,1X,A300)
 2400 FORMAT ('ECOTYPE        ',A12,1X,A300)
 2500 FORMAT ('CULTIVAR       ',A12,1X,A300)
 2600 FORMAT ('PESTS          ',A12,1X,A300)
 2700 FORMAT ('SOILS          ',A12,1X,A300)
 2800 FORMAT ('WEATHER        ',A12,1X,A300)
