...
!    INTEGER :: FNUMWRK                 ! File number,work file          #          ! (From RunInit)   
    ...
    CHARACTER (LEN=300) ARG           ! Argument component                        ! (From RunInit)  
    ...
    CHARACTER (LEN=312) CFGDFILE      ! Configuration directory+file              ! (From RunInit)  
    ...
    CHARACTER (LEN=312)  CUDIRFLE      ! Cultivar directory+file                   ! (From RunInit)  
    CHARACTER (LEN=312)  CUDIRFLPREV   ! Cultivar directory+file,prev              ! (From RunInit)  
    ...
    CHARACTER (LEN=312)  ECDIRFLE      ! Ecotype directory+file                    ! (From SeasInit) 
    CHARACTER (LEN=312)  ECDIRFLPREV   ! Ecotype directory+file,prev               ! (From RunInit)  
    ...
    CHARACTER (LEN=312) FILEA         ! Name of A-file                            ! (From SeasInit) 
    CHARACTER (LEN=312) FILEADIR      ! Name of A-file directory                  ! (From SeasInit) 
    CHARACTER (LEN=312) FILEIO        ! Name of input file,after check            ! (From RunInit)  
    CHARACTER (LEN=3)   FILEIOT       ! Type of input file                        ! (From RunInit)  
    CHARACTER (LEN=312) FILENEW       ! Temporary name of file                    ! (From SeasInit) 
    CHARACTER (LEN=312) FILET         ! Name of T-file                            ! (From Output)   
    CHARACTER (LEN=312) FILEX         ! Name of X-file                            ! (From SeasInit) 
    CHARACTER (LEN=1)   FNAME         ! File name switch (N->standard)            ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEERA      ! File name,A-errors                        ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEERT      ! File name,T-errors                        ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEEVAL     ! File name,evaluate outputs                ! (From RunInit)  
    CHARACTER (LEN=312) FNAMELEAVES   ! File name,leaves outputs                  ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEMEAS     ! File name,measured outputs                ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEOV       ! File name,overview outputs                ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEPHASES   ! File name,phases outputs                  ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEPHENOLM  ! File name,phenology measured              ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEPHENOLS  ! File name,phenology outputs               ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEPREM     ! File name,responses,measured              ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEPRES     ! File name,responses,simulated             ! (From RunInit)  
    CHARACTER (LEN=312) FNAMEPSUM     ! File name,plant summary                   ! (From RunInit)  
    ...
    CHARACTER (LEN=300)  PATHCR        ! Path to genotype (CUL) files              ! (From SeasInit) 
    CHARACTER (LEN=300)  PATHEC        ! Path to genotype (ECO) files              ! (From SeasInit) 
    CHARACTER (LEN=300)  PATHSP        ! Path to genotype (SPE) files              ! (From SeasInit) 
    ...
    CHARACTER (LEN=312)  SPDIRFLE      ! Species directory+file                    ! (From SeasInit) 
    CHARACTER (LEN=312)  SPDIRFLPREV   ! Species directory+file,last               ! (From RunInit)  
