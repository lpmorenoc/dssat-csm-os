...
!      INTEGER       FNUMREA       ! File number,reads.out file     #
      ...
      CHARACTER (LEN=300) ARG           ! Argument component
      CHARACTER (LEN=6)   CAIC          ! Canopy area index
      CHARACTER (LEN=6)   CANHTC        ! Canopy height
      CHARACTER (LEN=312) CFGDFILE      ! Configuration directory+file
      ...
      CHARACTER (LEN=312)  CUDIRFLE      ! Cultivar directory+file
      CHARACTER (LEN=312)  CUDIRFLPREV   ! Cultivar directory+file,prev
      ...
      CHARACTER (LEN=312)  ECDIRFLE      ! Ecotype directory+file
      CHARACTER (LEN=312)  ECDIRFLPREV   ! Ecotype directory+file,prev
      ...
      CHARACTER (LEN=312) FILEA         ! Name of A-file
      CHARACTER (LEN=312) FILEX         ! Name of X-file
      CHARACTER (LEN=312) FILEIO        ! Name of input file,after check
      CHARACTER (LEN=312) FILEIOIN      ! Name of input file
      CHARACTER (LEN=312) FILEADIR      ! Name of A-file directory      
      CHARACTER (LEN=3)   FILEIOT       ! Type of input file
      CHARACTER (LEN=312) FILENEW       ! Temporary name of file
      CHARACTER (LEN=312) FILET         ! Name of T-file
      CHARACTER (LEN=1)   FNAME         ! File name switch (N->standard)
      CHARACTER (LEN=312) FNAMEERA      ! File name,A-errors
      CHARACTER (LEN=312) FNAMEERT      ! File name,T-errors
      CHARACTER (LEN=312) FNAMEEVAL     ! File name,evaluate outputs
      CHARACTER (LEN=312) FNAMELEAVES   ! File name,leaves outputs
      CHARACTER (LEN=312) FNAMEMEAS     ! File name,measured outputs
      CHARACTER (LEN=312) FNAMEOV       ! File name,overview outputs
      CHARACTER (LEN=312) FNAMEPHASES   ! File name,phases outputs
      CHARACTER (LEN=312) FNAMEPHENOLM  ! File name,phenology measured
      CHARACTER (LEN=312) FNAMEPHENOLS  ! File name,phenology outputs
      CHARACTER (LEN=312) FNAMEPREM     ! File name,responses,measured
      CHARACTER (LEN=312) FNAMEPRES     ! File name,responses,simulated
      CHARACTER (LEN=312) FNAMEPSUM     ! File name,plant summary
      ...
      CHARACTER (LEN=300)  PATHCR        ! Path to genotype (CUL) files
      CHARACTER (LEN=300)  PATHEC        ! Path to genotype (ECO) files
      CHARACTER (LEN=300)  PATHSP        ! Path to genotype (SPE) files
      ...
      CHARACTER (LEN=312)  SPDIRFLPREV   ! Species directory+file,last
