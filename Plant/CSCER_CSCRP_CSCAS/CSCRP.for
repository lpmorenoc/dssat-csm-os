...
!      INTEGER       FNUMREA       ! File number,reads.out file     #
 ...
 !     REAL          TFLA          ! Temperature factor,leaf ap 0-1 #
   ...
   !   REAL          TTLA          ! Daily thermal time,lf.appearnc C.d
      ...
      CHARACTER (LEN=312)  PATHCR        ! Path to genotype (CUL) files
      CHARACTER (LEN=312)  PATHEC        ! Path to genotype (ECO) files
      CHARACTER (LEN=312)  PATHSP        ! Path to genotype (SPE) files
